        ...
        <div class="row">
          <div class="col-md-6">
            <div class="pricing-entry ftco-animate">
              ...
              <div class="d-block">
                <p>Miguel Angel&nbsp;&nbsp;<a href="#"><span style = "color:#000; font-size: 1.5em;" class="fas fa-pencil-alt"></span></a></p>
              </div>
            </div>
            <div class="pricing-entry ftco-animate">
              <h5 style="color:#000;">Email</h5>
              <div class="d-block">
                <p>pruebaAlexPiñero@gmail.com&nbsp;&nbsp;<a href="#"><span style = "color:#000; font-size: 1.5em;" class="fas fa-pencil-alt"></span></a></p>
              </div>
            </div>
            <div class="pricing-entry ftco-animate">
            ...
            <div class="pricing-entry ftco-animate">
              ...
              <a href="#modall" name ='modal_triggerr' id='modal_triggerr' style="color:#0000FF;font-size: 1.5em;">Cerrar Sesión&nbsp;&nbsp;<span style = "color:#0000FF; font-size: 1.5em;" class="fas fa-chevron-circle-left"></span></a></h5>
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="pricing-entry ftco-animate">
              ...
              <div class="d-block">
                <p>Tienes una cita pendiente el día 14/10/2019 a las 15:30 horas.&nbsp;&nbsp;<a href='#modall' name='modal_triggerr' id='modal_triggerr'><span style = "color:#0000FF; font-size: 1.5em;" class="fas fa-pencil-alt"></span>&nbsp;&nbsp;&nbsp;<span style = "color:#FF0000; font-size: 1.7em;" class="fas fa-times"></span></a></p>
              </div>
              <div class="d-block">
                <p>Tienes una cita pendiente el día 14/10/2019 a las 15:30 horas.&nbsp;&nbsp;<a href="#"><span style = "color:#0000FF; font-size: 1.5em;" class="fas fa-pencil-alt"></span>&nbsp;&nbsp;&nbsp;<span style = "color:#FF0000; font-size: 1.7em;" class="fas fa-times"></span></a></p>
              </div>
              <div class="d-block">
                <p>Tienes una cita pendiente el día 14/10/2019 a las 15:30 horas.&nbsp;&nbsp;<a href="#"><span style = "color:#0000FF; font-size: 1.5em;" class="fas fa-pencil-alt"></span>&nbsp;&nbsp;&nbsp;<span style = "color:#FF0000; font-size: 1.7em;" class="fas fa-times"></span></a></p>
              </div>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 heading-section ftco-animate text-center">
            <h2 class="mb-4" style="color:#FFF;">Nuestro Servicio</h2>
            <p class="flip"><span class="deg1"></span><span class="deg2"></span><span class="deg3"></span></p>
            <p class="mt-5" style="color:#FFF;">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
          </div>
        </div>
        <div class="row">
           <div class="col-md-4 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              ...
              <div class="text py-4 d-block">
                <h3 class="heading mt-2" ><a class="link" href="#popup1" style = "color:#FFF;">Historial</a></h3>
          ...
          <div class="col-md-4 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              ...
              <div class="text py-4 d-block">
                <h3 class="heading mt-2" ><a href="#" style = "color:#FFF;">Nuestra tienda online</a></h3>
          ...
          <div class="col-md-4 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              ...
              <div class="text py-4 d-block">
                <h3 class="heading mt-2" ><a href="#" style = "color:#FFF;">Corte + Lavado + Peinado</a></h3>
...
<div id="modall" class="popupContainer" style="display:none;">
