...
<script>
    $(document).ready(function() {
        ...
        function show_product(){
            ...
            $.ajax({
                type  : 'ajax',
                url : "<?php echo base_url('index.php/GestionAdmin/show_Contacto');?>",
                async : false,
                cache: true,
                dataType : 'json',
                success : function(data){
                    ...
                    for(i=0;i<data.length;i++)
                    {
                            ...
                            html += '<tr>'+
                                '<td style="border-color:#393e46;" align="center"><a>'+ data[i].fecha +'</a></td>'+
                                '<td style="border-color:#393e46;" align="center"><a>'+ data[i].asunto +'</a></td>'+
                                '<td style="border-color:#393e46;" align="center"><a>'+ data[i].comentario +'</a></td>'+
                                '<td style="border-color:#393e46;" align="center"><a>'+ data[i].nombre +'</a></td>'+
                                '<td style="border-color:#393e46;" align="center"><a>'+ data[i].email +'</a></td>'+
        ...
        $(document).on('click', 'button.removebutton', function () {
            var id = this.id;
            if(confirm("¿Estás seguro de eliminar el contacto?"))
            {
                $(this).closest('tr').remove();
                   ...
                   //document.write(id);
                $.ajax({
                    url : "<?php echo base_url('index.php/GestionAdmin/EliminarContacto');?>",
                    type: 'POST',
                    dataType: "json",
                    data: {'id':id},
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example" style="border-color:#393e46;">
                                <thead >
                                    <tr>
                                        ...
                                        <th style="background-color:#393e46; color:#FFF; border-color:#393e46;" align="center">Mensaje</th>
