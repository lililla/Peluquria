...
<script>
    $(document).ready(function() {
        ...
        function show_product(){
            ...
            var id = url.searchParams.get("publicacion");
            

            $.ajax({
                type  : 'ajax',
                type: 'POST',
                url : "<?php echo base_url('index.php/GestionAdmin/show_Comentario');?>",
                async : false,
                cache: true,
                dataType : 'json',
                data : {'id':id},
                success : function(data,dd){
                    ...
                    for(i=0;i<data.length;i++)
                    {
                            ...
                            html += '<tr>'+
                                ...
                                '<td style="border-color:#393e46;" align="center"><a>'+ data[i].id +'</a></td>'+
        ...
        $(document).on('click', 'button.removebutton', function () {
            ...
            if(confirm("¿Estás seguro de eliminar la publicación?"))
            {
                $(this).closest('tr').remove();
                   ...
                   //document.write(id);
                $.ajax({
                    url : "<?php echo base_url('index.php/GestionAdmin/EliminarComentario');?>",
                    type: 'POST',
                    dataType: "json",
                    data: {'id':id},
                    ...
                    <div class="panel panel-default" style="border-color:#393e46;">
                        ...
                        <div class="panel-body" style="background-color:#eeeeee; border-color:#393e46;">
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example" style="border-color:#393e46;">
                                <thead >
                                    <tr>
                                        <th style="background-color:#393e46;color:#FFF; border-color:#393e46;" align="center">Comentario</th>
