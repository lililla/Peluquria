...
<script>
    $(document).ready(function() {
        ...
        function show_product(){
            ...
            $.ajax({
                type  : 'ajax',
                url : "<?php echo base_url('index.php/GestionAdmin/show_RedSocial');?>",
                async : false,
                cache: true,
                dataType : 'json',
                success : function(data){
                    ...
                    for(i=0;i<data.length;i++)
                    {
                            ...
                            html += '<tr>'+
                                '<td style="border-color:#393e46;" align="center"><a href="http://192.168.0.12/Peluqueria/GestionAdmin/Comentario?publicacion='+ data[i].id +'">'+ data[i].asunto +'</a></td>'+
        ...
        $(document).on('click', 'button.removebutton', function () {
            ...
            if(confirm("¿Estás seguro de eliminar la publicación?"))
            {
                $(this).closest('tr').remove();
                   ...
                   //document.write(id);
                $.ajax({
                    url : "<?php echo base_url('index.php/GestionAdmin/EliminarRedSocial');?>",
                    type: 'POST',
                    dataType: "json",
                    data: {'id':id},
