...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Nuevo Trabajador</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form method="post" role="form" action="<?php echo base_url()?>GestionAdmin/setImagePrecio" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <p class="help-block">Ejemplo Laca</p>
                                        </div>
                                        <label>Precio</label>
                                        <div class="form-group input-group">
                                            <span class="input-group-addon"><i class="fa fa-eur"></i>
                                            </span>
                                            <input type="text" name="precio" class="form-control" <?php echo"value='".$precio->precio."'";?> placeholder="Font Awesome Icon">
                                        </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <a type="reset" class="btn btn-primary" href="<?php echo site_url() ?>GestionAdmin/Precio">Cancelar</a>
                                </div>
                                <!-- /.col-lg-6 (nested) -->
                            </div>
                            <!-- /.row (nested) -->
