                ...
                <div class="col-lg-12">
                    <div class="panel panel-default" style="border-color:#393e46;">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form method="post" role="form" action="<?php echo base_url()?>GestionAdmin/setImageNoticia" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label>Asunto</label>
                                            <input class="form-control" type="text" <?php echo"value='".$noticia->asunto."'";?> name="asunto" maxlength="21" required>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <a type="reset" class="btn btn-primary" href="<?php echo site_url() ?>GestionAdmin/Noticia">Cancelar</a>
                                </div>
                                <!-- /.col-lg-6 (nested) -->
                            </div>
                            <!-- /.row (nested) -->
