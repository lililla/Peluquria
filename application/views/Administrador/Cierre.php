...
<script>
    $(document).ready(function() {
        ...
        function show_product(){
            ...
            $.ajax({
                type  : 'ajax',
                url : "<?php echo base_url('index.php/GestionAdmin/show_Cierre');?>",
                async : false,
                cache: true,
                dataType : 'json',
                success : function(data){
                    ...
                    for(i=0;i<data.length;i++)
                    {
                        ...
                        {
                            html += '<tr>'+
                                '<td style="border-color:#393e46;" align="center"ccc>'+ data[i].fecha +'</td>'+
                        ...
                        {
                            html += '<tr>'+
                                '<td style="border-color:#393e46;" align="center">'+ data[i].fecha2 +'</td>'+
                                '<td style="border-color:#393e46;" align="center"><button type="button" id="'+ data[i].id +'" class="removebutton"><i style="color:red;" class="fa fa-times fa-2x"></i></button></td>'+
                                '</tr>';
                        }
        ...
        $(document).on('click', 'button.removebutton', function () {
            var id = this.id;
            if(confirm("¿Estás seguro de eliminar el cierre?"))
            {
                $(this).closest('tr').remove();
                   ...
                   //document.write(id);
                $.ajax({
                    url : "<?php echo base_url('index.php/GestionAdmin/EliminarCierre');?>",
                    type: 'POST',
                    dataType: "json",
                    data: {'id':id},
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Cierres</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                    ...
                    <div class="panel panel-default" style="border-color:#393e46;">
                        ...
                        <div class="panel-body" style="background-color:#eeeeee; border-color:#393e46;">
                            ...
                            <div class="well" style="background-color:#393e46; border-color:#393e46;">
                                ...
                                <a style="background-color:#929aab; border-color:#393e46; color:#393e46;" class="btn btn-default btn-lg btn-block" href="<?php echo site_url() ?>GestionAdmin/NuevoCierre">Nuevo Cierre</a>
                            </div>
                            <!-- /.table-responsive -->
