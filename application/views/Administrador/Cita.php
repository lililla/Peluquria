...
<script>
    $(document).ready(function() {
        ...
        function show_product(){
            ...
            $.ajax({
                type  : 'ajax',
                url : "<?php echo base_url('index.php/GestionAdmin/show_Cita');?>",
                async : false,
                cache: true,
                dataType : 'json',
                success : function(data){
                    ...
                    for(i=0;i<data.length;i++)
                    {
                            ...
                            html += '<tr>'+
                                ...
                                '<td style="border-color:#393e46;" align="center"><a>'+ data[i].hora +'</a></td>'+
                                '<td style="border-color:#393e46;" align="center"><a>'+ data[i].id_personal +'</a></td>'+
                                '<td style="border-color:#393e46;" align="center"><a>'+ data[i].id_login +'</a></td>'+
        ...
        $(document).on('click', 'button.removebutton', function () {
            ...
            if(confirm("¿Estás seguro de eliminar la cita?"))
            {
                $(this).closest('tr').remove();
                   ...
                   //document.write(id);
                $.ajax({
                    url : "<?php echo base_url('index.php/GestionAdmin/EliminarCita');?>",
                    type: 'POST',
                    dataType: "json",
                    data: {'id':id},
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example" style="border-color:#393e46;">
                                <thead >
                                    <tr>
                                        ...
                                        <th style="background-color:#393e46; color:#FFF; border-color:#393e46;" align="center">Hora</th>
                                        <th style="background-color:#393e46; color:#FFF; border-color:#393e46;" align="center">Cliente</th>
                                        <th style="background-color:#393e46; color:#FFF; border-color:#393e46;" align="center">Peluquero</th>
