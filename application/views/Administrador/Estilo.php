...
<script>
    $(document).ready(function() {
        ...
        function show_product(){
            ...
            $.ajax({
                type  : 'ajax',
                url : "<?php echo base_url('index.php/GestionAdmin/show_Estilo');?>",
                async : false,
                cache: true,
                dataType : 'json',
                success : function(data){
                    ...
                    for(i=0;i<data.length;i++)
                    {
                        ...
                        {
                            html += '<tr>'+
                                '<td style="border-color:#393e46;" align="center"><a href="http://192.168.0.12/Peluqueria/GestionAdmin/UpdateEstilo?asunto='+ data[i].asunto +'">'+ data[i].asunto +'</a></td>'+
                                '<td style="border-color:#393e46;" align="center">'+ data[i].fecha +'</td>'+
                                '<td style="border-color:#393e46;" align="center"><form action="http://192.168.0.12/Peluqueria/GestionAdmin/Estilo" method="post"><label class="label"><input  type="submit" name="visible" value="'+ data[i].id +'" id="check" class="label__checkbox" type="submit"/><i style="color:green;" class="fa fa-lock fa-3x"></i></label></form></td>'+
                        ...
                        else
                        {
                            html += '<tr>'+
                                '<td style="border-color:#393e46;" align="center"><a href="http://192.168.0.12/Peluqueria/GestionAdmin/UpdateEstilo?asunto='+ data[i].asunto +'">'+ data[i].asunto +'</a></td>'+
                                '<td style="border-color:#393e46;" align="center">'+ data[i].fecha +'</td>'+
                                '<td style="border-color:#393e46;" align="center"><form action="http://192.168.0.12/Peluqueria/GestionAdmin/Estilo" method="post"><label class="label"><input  type="submit" name="visible" value="'+ data[i].id +'" id="check" class="label__checkbox" type="submit"/><i style="color:green;" class="fa fa-unlock fa-3x"></i></label></form></td>'+
                                '<td style="border-color:#393e46;" align="center"><button type="button" id="'+ data[i].id +'" class="removebutton"><i style="color:red;" class="fa fa-times fa-2x"></i></button></td>'+
                                '</tr>';
                        }
        ...
        $(document).on('click', 'button.removebutton', function () {
            var id = this.id;
            if(confirm("¿Estás seguro de eliminar el estilo?"))
            {
                $(this).closest('tr').remove();
                   ...
                   //document.write(id);
                $.ajax({
                    url : "<?php echo base_url('index.php/GestionAdmin/EliminarEstilo');?>",
                    type: 'POST',
                    dataType: "json",
                    data: {'id':id},
                    ...
                    <div class="panel panel-default" style="border-color:#393e46;">
                        ...
                        <div class="panel-body" style="background-color:#eeeeee; border-color:#393e46;">
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example" style="border-color:#393e46;">
                                <thead >
                                    <tr>
                                        <th style="background-color:#393e46;color:#FFF; border-color:#393e46;" align="center">Asunto</th>
                                        <th style="background-color:#393e46; color:#FFF; border-color:#393e46;" align="center">Fecha</th>
                            ...
                            <div class="well" style="background-color:#393e46; border-color:#393e46;">
                                ...
                                <a style="background-color:#929aab; border-color:#393e46; color:#393e46;" class="btn btn-default btn-lg btn-block" href="<?php echo site_url() ?>GestionAdmin/NuevoEstilo">Nuevo Estilo</a>
                            </div>
                            <!-- /.table-responsive -->
