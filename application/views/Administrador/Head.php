            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<?php echo site_url() ?>GestionAdmin/Admin"><i class="fa fa-dashboard fa-fw"></i> Home</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="<?php echo site_url() ?>GestionAdmin/Noticia"><i class="fa fa-table fa-fw"></i> Noticias</a>
                        </li>
                        <li>
                            <a href="<?php echo site_url() ?>GestionAdmin/Personal"><i class="fa fa-table fa-fw"></i> Personal</a>
                        </li>
                        <li>
                            <a href="<?php echo site_url() ?>GestionAdmin/Precio"><i class="fa fa-table fa-fw"></i> Servicio y Precio</a>
                        </li>
                        <li>
                            <a href="<?php echo site_url() ?>GestionAdmin/Productos"><i class="fa fa-table fa-fw"></i> Productos</a>
                        </li>
                        <li>
                            <a href="<?php echo site_url() ?>GestionAdmin/Estilo"><i class="fa fa-table fa-fw"></i> Estilo</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-wrench fa-fw"></i>Cita<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo site_url() ?>GestionAdmin/ListaCita">Lista</a>
                                </li>
                                <li>
                                    <a href="<?php echo site_url() ?>GestionAdmin/Horarios">Horarios</a>
                                </li>
                                <li>
                                    <a href="<?php echo site_url() ?>GestionAdmin/Cierres">Cierres</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo site_url() ?>GestionAdmin/ListaClientes">Lista</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
