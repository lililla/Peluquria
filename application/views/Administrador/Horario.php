...
<script>
    $(document).ready(function() {
        ...
        function show_product(){
            ...
            $.ajax({
                type  : 'ajax',
                url : "<?php echo base_url('index.php/GestionAdmin/show_Horario');?>",
                async : false,
                cache: true,
                dataType : 'json',
                success : function(data){
                    ...
                    for(i=0;i<data.length;i++)
                    {
                            ...
                            html += '<tr>'+
                                '<td style="border-color:#393e46;" align="center">'+ data[i].tipo +'</td>'+
        ...
        $(document).on('click', 'button.removebutton', function () {
            var id = this.id;
            if(confirm("¿Estás seguro de eliminar el horario?"))
            {
                $(this).closest('tr').remove();
                   ...
                   //document.write(id);
                $.ajax({
                    url : "<?php echo base_url('index.php/GestionAdmin/EliminarHorario');?>",
                    type: 'POST',
                    dataType: "json",
                    data: {'id':id},
                    ...
                    <div class="panel panel-default" style="border-color:#393e46;">
                        ...
                        <div class="panel-body" style="background-color:#eeeeee; border-color:#393e46;">
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example" style="border-color:#393e46;">
                                <thead >
                                    <tr>
                                        <th style="background-color:#393e46;color:#FFF; border-color:#393e46;" align="center">tipo</th>
                            ...
                            <div class="well" style="background-color:#393e46; border-color:#393e46;">
                                ...
                                <a style="background-color:#929aab; border-color:#393e46; color:#393e46;" class="btn btn-default btn-lg btn-block" href="<?php echo site_url() ?>GestionAdmin/NuevoHorario">Nuevo Horario</a>
                            </div>
                            <!-- /.table-responsive -->
